    ...
    AlertDialog(
        ...
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                if (startDateError) Text("La fecha de inicio es requerida", style = MaterialTheme.typography.labelSmall, color = MaterialTheme.colorScheme.error)
        ...
        confirmButton = {
            TextButton(onClick = {
                ...
                dateOrderError = endDate.isNotBlank() && runCatching {
                    kotlinx.datetime.LocalDate.parse(startDate) > kotlinx.datetime.LocalDate.parse(endDate)
                }.getOrDefault(false)
